...
public partial class PregrineData : System.Web.UI.Page
{
                ...
                try
                {
                                 ...
                                 new OleDbConnection(excelConnectionString))
                    {
                        ...
                        using (DbDataReader dr = command.ExecuteReader())
                        {
                            ...
                            string sqlConnectionString = @"Data Source=.;Initial Catalog=Development;Integrated Security=True";

                            // Bulk Copy to SQL Server
                            using (SqlBulkCopy bulkCopy =
                                       new SqlBulkCopy(sqlConnectionString))
                            {
                                bulkCopy.DestinationTableName = "PTS_PRG_TempData";
